$(function () {
    var mediumPromise = new Promise(function (resolve) {
        ...
        var data = {
            rss: 'https://medium.com/feed/@owenselles'
        };
        $.get('https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.com%2Ffeed%2F%40owenselles', data, function (response) {
